...
<div class="row py-1">
    ...
    <div class="col-12 text-center mb-1">
        <a class="btn btn-outline-danger btn-rounded btn-lg z-depth-0 py-3" role="button" href="/?act=logout&hash=`+ config.hash.logout +`" onclick="return nav.go(this);"><span class="theme-title" data-lang="app_user_logout_btn"></span></a>
    </div>
</div>
            `,
