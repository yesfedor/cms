...
<div class="col-10 offset-1 border rounde text-center py-3 my-3">
    <a href="//media.iny.su" class="h3 theme-title py-0 mt-0 mb-3">Перейти в новую версию медиатеки</a>
    <h5 class="theme-text py-0 mt-3 mb-0">Поддержка этой версии прекращена</h5>
</div>
...
<script>
init.js.add('wc-AppMediaCard', 'wc:AppMediaCard', 35)
setTimeout(() => {
    mediaIntro.init()
}, 500)
...
nav.onunload = () => {
    ...
    toastr.info('Отмена перехода на медиатеку')
    delete mediaTimeOut
}
</script>