                        ...
                        <div class="col-12 text-center mt-5">
                            <div class="card border-warning z-depth-1">
                                ...
                                <div class="card-body text-warning">
                                    ...
                                    <p class="card-text">
                                        Если вы считаете, что ошибка произошла по нашей вине, обратитесь в <b><a class="text-warning" href="//iny.su/support/new">службу поддержки</a></b>
                                        <span class="d-block"><a class="text-warning" href="/">Вернуться главную</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
