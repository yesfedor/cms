    ...
    switch($type) {
        case 'text':
            ...
            <div style="'.$style.'" data-name="'.$name.'" class="md-form col-10 offset-1 my-1 py-1">
                ...
                <label class="ml-3 active" for="'.$id.'">'.$place.'</label>
        ...
        case 'select':
            ...
            $html = '
            <select style="'.$style.'" data-name="'.$name.'" id="'.$id.'" name="'.$name.'" class="mdb-select md-form col-10 offset-1 my-1 py-1">
        ...
        case 'multiselect':
            ...
            <select style="'.$style.'" id="'.$id.'" name="'.$name.'[]" data-name="'.$name.'" class="mdb-select colorful-select dropdown-primary md-form col-10 offset-1 my-1 py-1" multiple searchable="'.$lang['search_here'].'">
                <option value="" disabled>'.$place.'</option>
                '.$option.'
            </select>'.($js ? '<script>'.$js.'</script>':'').'
            <script>$("#'.$id.'").materialSelect();</script>
...
$bigData['html']['warp-page-helper'] = '
        <div class="col-12 h-100 white border border-primary offset-1 text-center">
            <h5>
