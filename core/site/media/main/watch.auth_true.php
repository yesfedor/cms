                ...
                <div class="col-12 col-xl-9">
                    <div class="row">
                        ...
                        <div class="col-12 theme-panel embed-responsive embed-responsive-16by9">
                            <iframe id="watch_player" class="embed-responsive-item" src="" frameborder="0" scrolling="no" allowfullscreen="" referrerpolicy="origin"></iframe>
                        </div>

                        <!-- Title -->
                        <div class="col-12 px-3 px-md-0">
                            <h4 id="watch_title" class="w-75 text-left theme-title text-capitalize mt-3 mb-0 float-left"></h4>
                            <h4 class="w-25 text-right text-muted mt-3 mb-0 float-left"><?= $content['data']['year'] ?></h4>
                            <h4 id="watch_date" class="d-none"></h4>
                        </div>
                        ...
                        <div class="col-12 accordion md-accordion my-3 px-0" id="reviewsPanel" role="tablist" aria-multiselectable="true">
                            <!-- Accordion card -->
                            <div class="card <?= ($reviewsData[0]['title'] ? 'd-block':'d-none') ?>">
                                <div class="card-header theme-background" role="tab" id="reviewsCard-1">
                                    <a data-toggle="collapse" data-parent="#reviewsPanel" href="#reviewsCard-1Content" aria-expanded="true" aria-controls="reviewsCard-1Content">
                                        <h5 class="mb-0 theme-title"><?= $reviewsData[0]['title'] ?><i class="fas fa-angle-down rotate-icon theme-icon"></i></h5>
                                    </a>
                                </div>
                                <div id="reviewsCard-1Content" class="collapse show" role="tabpanel" aria-labelledby="reviewsCard-1" data-parent="#reviewsPanel">
                                    <div class="card-body theme-background">
                                        <h5 class="theme-text my-0"><?= $reviewsData[0]['content'] ?></h5>
                                    </div>
                                </div>
                            </div>
                            <!-- Accordion card -->
                            ...
                            <!-- Accordion card -->
                            <div class="card <?= ($reviewsData[1]['title'] ? 'd-block':'d-none') ?>">
                                <div class="card-header theme-background" role="tab" id="reviewsCard-2">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#reviewsPanel" href="#reviewsCard-2Content" aria-expanded="false" aria-controls="reviewsCard-2Content">
                                        <h5 class="mb-0 theme-title"><?= $reviewsData[1]['title'] ?><i class="fas fa-angle-down rotate-icon theme-icon"></i></h5>
                                    </a>
                                </div>
                                <div id="reviewsCard-2Content" class="collapse" role="tabpanel" aria-labelledby="reviewsCard-2" data-parent="#reviewsPanel">
                                    <div class="card-body theme-background theme-text">
                                        <h5 class="theme-text my-0"><?= $reviewsData[1]['content'] ?></h5>
                                    </div>
                                </div>
                            </div>
                            <!-- Accordion card -->
                            ...
                            <!-- Accordion card -->
                            <div class="card <?= ($reviewsData[2]['title'] ? 'd-block':'d-none') ?>">
                                <div class="card-header theme-background" role="tab" id="reviewsCard-3">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#reviewsPanel" href="#reviewsCard-3Content" aria-expanded="false" aria-controls="reviewsCard-3Content">
                                        <h5 class="mb-0 theme-title"><?= $reviewsData[2]['title'] ?><i class="fas fa-angle-down rotate-icon theme-icon"></i></h5>
                                    </a>
                                </div>
                                <div id="reviewsCard-3Content" class="collapse" role="tabpanel" aria-labelledby="reviewsCard-3" data-parent="#reviewsPanel">
                                    <div class="card-body theme-background theme-text">
                                        <h5 class="theme-text my-0"><?= $reviewsData[2]['content'] ?></h5>
                                    </div>
                                </div>
                            </div>
                            <!-- Accordion card -->
...
} else init.js.add('media-watch', 'module/media.watch.js', 4122)
