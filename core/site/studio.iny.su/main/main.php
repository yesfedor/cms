        ...
        <div class="col-12 py-3">
            <div class="row">
                <div class="col-12 text-center mt-5 mb-3">
                    <h2 class="black-text font-weight-bold">Наши услуги</h2>
                </div>
                ...
                <div class="container mt-5 pt-5 pb-3 px-5 z-depth-1 white">
        ...
        <div class="col-12 text-center py-3">
            <div class="row">
                <div class="col-12 text-center my-5">
                    <h2 class="black-text font-weight-bold">Почему мы?</h2>
                </div>
                <div class="col-12">
                    <div class="container row mx-auto mb-5">
                        <div class="col-12 col-lg-4 black-text text-center">
                ...
                <div class="col-12 text-center mt-5 mx-0">
